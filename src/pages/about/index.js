        ...
        <div>
          ...
          <Row>
            <Col md={8} mdOffset={2}>
                ...
                <Masthead/>
                <p>I spend my days working in the e-commerce department on the new Ocado Smart Platform. My focus is on developer experience, and looking after the build and release process for our suite of 40+ web services and applications. I'm a big <Anchor href="https://gitlab.com/ci" target="_blank">GitlabCI</Anchor> fan, and alongside that I have written and maintain a suite of custom tooling to support performing deployments to AWS. I get to work with modern stacks for both Java and Node applications, and write integrations for other tools such as Slack.</p>
                <p>In 2015 I submitted my Ph.D Thesis in Computer Science, on the topic of delivering content into Augmented Reality environments (if you're really keen, you can <Anchor href="http://etheses.dur.ac.uk/11332/">read it here</Anchor>).
