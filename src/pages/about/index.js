...
const About = () => (
  <Row>
    <Col xs={10} xsOffset={1} md={8} mdOffset={2}>
      ...
      <Text>When I&apos;m not working I have a passion for home automation, and I try to find time to get out on my bike. I&apos;m also pretty nerdy about coffee and have more methods of making it in the kitchen than space will reasonably allow.
      </Text>
