...
_I'm illustrating this with Node-RED flow diagrams, as that's my platform of choice for automation, but the principle is easily reproducible in native Home Assistant automations._
## Getting it Working
