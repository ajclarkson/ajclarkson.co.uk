---
layout: post
title: A New Blog - But Why Choose Jekyll
excerpt: I've started my blog from scratch, and moved from wordpress to Jekyll in the process. So why the change?
tags: [Jekyll]

---

The last incarnation of my blog was something of an experiment for me. I was running Wordpress, as I always did, and becoming increasingly attracted to the idea of having the ability to "Art Direct" certain posts. [Trent Walton](http://www.trentwalton.com), [Jason Santa Maria](http://www.jasonsantamaria.com), and [Craig Mod](http://www.craigmod.com) all played a part in fueling my desire to experiment with this. And I wasn't alone. A whole slew of plugins exist for Wordpress to give you the ability to specify custom CSS, Javascript and so forth, but they always felt like a workaround. Something that created messy, unneccessary code. Surely, there must be a better way?

[Jekyll](http://www.jekyllrb.com) allows you to construct a post as a markdown, or a HTML file, which meant that I ccould actually edit the layout of a post, directly where I was writing the content. By manipulating the HTML around what I was writing, there was no need for ugly hacks, or creation of page specific templates that needed uploading before I could use them. For all intents and purposes, it allows you to _design_ every single page or post you add to your site.
